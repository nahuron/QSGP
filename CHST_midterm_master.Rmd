...
DR_invasives <- ggplot(data = Rep_aqua_invasives)+
  ...
  scale_fill_gradient2(name = "", low = "#000066", mid = "#99CCFF", high = "#FF0000", midpoint = 0, labels = c("High SR Republican", "High SR Democrat"), breaks = c(32, -8))+
...
#Republican areas are labeled in shades of red. Democratic areas are labeled in shades of blue.
```
