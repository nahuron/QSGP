...
##Question and Problem (need to edit)
...
![An individual of *Leiocephalus psammodromus* displays the tail-curling behavior that gives rise to the common name of this genus. This smaller-bodied species is especially threatened according to IUCN criteria.](/Volumes/GoogleDrive/My Drive/G_Huron_Nicholas_A_UPLOAD/psammodromus.jpeg){ width=50% }
...
pp <- ggplot(data = leio_env_morph, aes(y = log(leio_env_morph$elev_rangediff, base = 10), x = distance)) +
  ...
  labs(y = "Elevation Range (m)", x = "Distance from Centroid in PC Space") +
  xlim(-1, 9)
