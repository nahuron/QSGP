...
#ln.dat.morph <- as_tibble(cbind(dat.morph[,1], ln.dat.morph))
#row names do not behave with tibbles
#ln.dat.morph <- as_tibble(ln.dat.morph)
rownames(ln.dat.morph) <- as.character(dat.morph$species)
