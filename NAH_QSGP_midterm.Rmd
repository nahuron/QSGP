...
```{r shapiro tests}
#Authors: NAH
swtest_grains <- tibble(untransformed = NA, logtransformed = NA, untransformed.p = NA, logtransformed.p = NA)
for(e in seq_along(sr_per_grain)){
  compare_holder <- c(NA, NA, NA, NA)
  names(compare_holder) <- c("untransformed", "logtransformed", "untransformed.p", "logtransformed.p")
...
swtest_speciestype <- tibble(untransformed = NA, logtransformed = NA, untransformed.p = NA, logtransformed.p = NA)
