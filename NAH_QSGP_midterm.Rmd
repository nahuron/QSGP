...
invasives2 %>%
  ...
  filter(str_detect(obscomments_long, pattern = "[dD]ate")) %>%
...
We now can confirm that there are 724 rows that contain some reference to the date in the comments section. These likely represent dates that need fixing or may need to be removed from the dataset. We also realize we need to format the dates at some point.
