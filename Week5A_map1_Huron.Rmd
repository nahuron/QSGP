...
```{r subset and smush, fig.height = 6, fig.width = 8, warning=F}
...
Now we need to create a version of `county` (see above) for each decade to use.
```{r smush}
#now smush together
